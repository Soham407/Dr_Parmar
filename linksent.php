     ...
     <?php include "header.php"; ?>
      ...
      <div class="denturelab-banner">
       ...
       <div class="container" style="margin-top:60px;margin-bottom:80px">
           <h4 style="text-align:center;width:100%;font-weight:bold">Thank you.</h4>
           <h6 style="text-align:center;width:100%;">Now you just need to upload the photos on the Link sent on your Mobile No/Email Address</h6>
