...
<!--                        <span style="color: red;font-size : 8pt"><i>It's look like you're on Computer...</i></span>-->
                       ...
                       <span style="color: red;font-size : 8pt"><i>If you are from USA enter your mobile number below. And if you are outside of USA enter your email.</i></span>
                        <input type="text" name="smsmobile" id="smsmobile" class="form-control"/>
                        <br>
                        <div class="col-md-12">
                            <button type="button" class="btn btn-primary modalbutton" style="width : 100%" onclick="submitFormSMS()" >Send link to mobile</button>
                           </div>
                           <br>
...
//             frmSanpSmile
            ...
            frm.action = 'https://www.teledentcare.com/plugin/acceptdata.php' 
...
//             debugger;
//             frmSanpSmile
            var smsmobile = document.getElementsByName('smsmobile');
            
            if(smsmobile.value == ""){
                alert("Enter Mobile Number where we can send SMS.");
            }else{
                var modal = document.getElementById('close');
                modal.click();
                var frm = document.getElementsByName('frmSanpSmile')[0];
