     ...
     <?php include "header.php"; ?>
      ...
      <div class="denturelab-banner">
       ...
       <div class="container" style="margin-top:60px;margin-bottom:80px">
           <h4 style="text-align:center;width:100%;font-weight:bold">Photos Saved</h4>
           <h6 style="text-align:center;width:100%;">Thank you. Your Dentist will contact you soon.</h6>
