...
-->               </div>
                ...
                <div class="col-md-12" style="padding-top:20px;padding-bottom:20px;display:none" id="amparo">
      ...
      <script src = "js/bootstrap.min.js"></script>
               ...
               if(val == '3')
                   {
                       ...
                       document.getElementById("drarshiya").style.display = "none";
                       document.getElementById("drthomas").style.display = "none";
                       document.getElementById("amparo").style.display = "block";
       ...
       <script>
           ...
           if(res[1] == 'drparmar')
               ...
               if(res[1] == 'amparo' || res[1] == 'pamcollier' || res[1] == 'patricia' || res[1] == 'sandra' || res[1] == 'bella')
                   {
                       document.getElementById("drparmar").style.display = "none";
                       document.getElementById("drshah").style.display = "none";
                       document.getElementById("drarshiya").style.display = "none";
                       ...
                       if(subsec == 'amparo')
                           {
                               var elmnt = document.getElementById("amparo");
                                elmnt.scrollIntoView(); 
                           }
